...
/**
 * [ESBuild](https://esbuild.github.io) plugin that loads .bk files as their Backolon AST
 * (the result of calling {@link parse} on their contents) as well as exporting the source
 * code as a string.
 */
const plugin: Plugin = {
